Trocar o banco por nome minúsculo.

nome da tabela precisa ser nome da tabela _id 

Trocar as consultas por uso do using



typeof window.showOpenFilePicker === 'undefined', <-- teste para saber se é possível salvar na máquina.
